...
public final class TimeUtils {
    ...
    /**
     * This function and pattern are taken from the Essentials project because I am lazy
     */
    ...
    public static long mustParseDateDiff(String time, boolean future) {
        try {
            return parseDateDiff(time, future);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1L;
    ...
    public static String formatDateDiff(long date) {
        ...
        return TimeUtils.formatDateDiff(now, c);
    }
